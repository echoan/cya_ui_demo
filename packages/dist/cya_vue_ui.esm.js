 ...
 * @LastEditors: Chengya
 * @LastEditTime: 2024-12-13 14:16:07
 */
 ...
 * @LastEditors: Chengya
 * @LastEditTime: 2024-12-13 10:31:49
 */
console.log("当前版本：", "1.0.0");
const components = [CyaButton]; // index.js 建立的目的 在于 将来如果定义的组件多了 可以统一通过这个入口文件 全部引用
...
export { CyaButton, index as default };
